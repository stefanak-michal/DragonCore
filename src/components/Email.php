...
namespace Dragon\components;

use Dragon\helpers\Validation;
...
class Email
{
     ...
     * Send any email
     *
     * @param \Dragon\View $view
     * @return boolean
     */
    public function send(\Dragon\View $view): bool
    {
        $output = false;
        ...
        if (!empty($this->content)) {
            ...
            try {
                ...
                \Dragon\Debug::var_dump($e->getMessage());
            }
        }
